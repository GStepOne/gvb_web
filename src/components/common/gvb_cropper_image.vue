...
import {IconPlusCircle, IconMinusCircle, IconRefresh} from "@arco-design/web-vue/es/icon";
...
<template>
  <div>
    ...
    >
      <!--核心内容-->
      <template #default>
        <div class="cropper" @close="dialogVisible = false">
          <!--裁剪左侧内容-->
      ...
      <template #footer>
        <span class="dialog-footer">
          <a-button @click="dialogVisible = false" status="danger">取消</a-button>
          <a-button type="outline" @click="refreshCrop">重置</a-button>
